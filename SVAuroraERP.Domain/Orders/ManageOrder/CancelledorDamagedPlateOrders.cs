...
{
    [Table("V_CancelledorDamagedPlateOrders")]
    public class VCancelledorDamagedPlateOrders
    {
        ...
        [Column("FK_HSRPOrderRectificationReasonID")] public byte? HSRPOrderRectificationReasonID { get; set; }
    ...
    public class CancelledorDamagedPlateOrdersRequest : DataTableRequest
    {
