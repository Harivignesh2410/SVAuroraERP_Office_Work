...
{
    [Table("V_DeliveryAcknowledgement")]
    public class VDeliveryAcknowledgement
    {
    ...
    public class DeliveryAcknowledgementOrdersRequest : DataTableRequest
    {
    ...
    [Table("tHSRPVehiclePlateImage")]
    public class HSRPVehiclePlateImage
    {
        ...
        [NotMapped] public DateOnly? OrderDate { get; set; }
