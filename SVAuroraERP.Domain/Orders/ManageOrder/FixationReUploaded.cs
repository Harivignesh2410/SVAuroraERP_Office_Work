...
{
    [Table("V_FixationReUploaded")]
    public class VFixationReUploaded
    {
    ...
    public class FixationReUploadedRequest : DataTableRequest
    {
    ...
    public class SaveFixationReUploadedRequest
    {
