...
{
    [Table("V_GetReadyforQualityProcessing")]
    public class VGetReadyforQualityProcessing
    {
    ...
    public class ReadyforProcessingOrdersRequest : DataTableRequest
    {
    ...
    public class HsrpLaserNoDataTable
    {
        public DataTable? dtLaserNoSummary { get; set; }
    }

    public class VHsrpLaserNoDataTable
    {
    ...
    public class HSRPLaserDataResponse
    {
        public List<VHsrpLaserNoDataTable> lstLaserNoSummary { get; set; }
    }
