...
{
    public class CancelledorDamagedPlateOrdersServiceRepository : ICancelledorDamagedPlateOrdersServiceRepository
    {
        private readonly SVAuroraERPDbContext _dbcontext;
        private readonly IErrorLoggerService _errorLoggerService;
        private readonly IAuditLogger _auditLogger;
        public CancelledorDamagedPlateOrdersServiceRepository(IErrorLoggerService errorLoggerService,
        ...
        public DataResponse GetCancelledorDamagedPlateOrders(CancelledorDamagedPlateOrdersRequest request)
        {
            ...
            try
            {
                ...
                IQueryable<VCancelledorDamagedPlateOrders> query = _dbcontext.VCancelledorDamagedPlateOrders;
                ...
                var totalRecords = _dbcontext.VCancelledorDamagedPlateOrders.Count();
