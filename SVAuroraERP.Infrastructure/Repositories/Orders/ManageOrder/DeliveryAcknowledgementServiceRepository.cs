...
{
    public class DeliveryAcknowledgementServiceRepository : IDeliveryAcknowledgementServiceRepository
    {
        private readonly SVAuroraERPDbContext _dbcontext;
        private readonly IErrorLoggerService _errorLoggerService;
        private readonly IAuditLogger _auditLogger;
        public DeliveryAcknowledgementServiceRepository(IErrorLoggerService errorLoggerService,
        ...
        public DataResponse GetDeliveryAcknowledgementOrders(DeliveryAcknowledgementOrdersRequest request)
        {
            ...
            try
            {
                ...
                IQueryable<VDeliveryAcknowledgement> query = _dbcontext.VDeliveryAcknowledgement;
                ...
                var totalRecords = _dbcontext.VDeliveryAcknowledgement.Count();
        ...
        public DataResponse SaveHSRPPlateImage(HSRPVehiclePlateImage request)
        {
            ...
            try
            {
                ...
                command.CommandText = "UpdateHSRPOrderStatusToFittedOrder";
                command.CommandType = CommandType.StoredProcedure;

                var pkhsrpvehicleplateimageid = command.CreateParameter();
                pkhsrpvehicleplateimageid.ParameterName = "@PK_HSRPVehiclePlateImageID";
                pkhsrpvehicleplateimageid.Direction = System.Data.ParameterDirection.Output;
                pkhsrpvehicleplateimageid.DbType = System.Data.DbType.Int32;
                pkhsrpvehicleplateimageid.Value = 0;

                command.Parameters.Add(pkhsrpvehicleplateimageid);
                command.Parameters.Add(new SqlParameter("@FK_OrderID", request.OrderID));
                command.Parameters.Add(new SqlParameter("@FrontLaserNoURL", request.FrontLaserNoURL));
                command.Parameters.Add(new SqlParameter("@RearLaserNoURL", request.RearLaserNoURL));
                command.Parameters.Add(new SqlParameter("@LastUpdatedBy", request.LastUpdatedBy));
                using (var reader = command.ExecuteReader())
                {
                    int id = (int)pkhsrpvehicleplateimageid.Value;
                ...
                _auditLogger.SaveActionLog("HSRPVehiclePlateImage", ActionType.Insert, response.ID.ToString(), request, null, "DeliveryAcknowledgementServiceRepository.SaveHSRPPlateImage()");

            }
            catch (Exception ex)
            {
                response = _errorLoggerService.LogException(ex, request, "DeliveryAcknowledgementServiceRepository.SaveHSRPPlateImage()");
            }
            return response;
        }
    }
