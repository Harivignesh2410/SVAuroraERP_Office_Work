namespace SVAuroraERP.Infrastructure.Repositories.Orders.ManageOrder
{
    public class DispatchedServiceRepository : IDispatchedServiceRepository
    {
        ...
        public DispatchedServiceRepository(IErrorLoggerService errorLoggerService,
        ...
        public DataResponse GetDispatched(DispatchedOrdersRequest request)
        {
            ...
            try
            {
                ...
                IQueryable<VDispatchedOrders> query = _dbcontext.VDispatchedOrders;
                ...
                var totalRecords = _dbcontext.VDispatchedOrders.Count();
                ...
                _auditLogger.SaveActionLog("VDispatchedOrders", ActionType.ListData, null, request, null, "DispatchedServiceRepository.GetDispatched()");
            }
            catch (Exception ex)
            {
                response = _errorLoggerService.LogException(ex, request, "DispatchedServiceRepository.GetDispatched()");
            }
            return response;
        }
    }
