...
{
    public class FittedOrdersServiceRepository : IFittedOrdersServiceRepository
    {
        private readonly SVAuroraERPDbContext _dbcontext;
        private readonly IErrorLoggerService _errorLoggerService;
        private readonly IAuditLogger _auditLogger;
        public FittedOrdersServiceRepository(IErrorLoggerService errorLoggerService,
        ...
        public DataResponse GetFittedOrder(FittedOrderRequest request)
        {
            ...
            try
            {
                ...
                IQueryable<VFittedOrders> query = _dbcontext.VFittedOrders;
                ...
                var totalRecords = _dbcontext.VFittedOrders.Count();
        ...
        public DataResponse UpdateVehiclePlateStatus(SaveFittedOrderRequest model)
        {
        ...
        public DataResponse GetVehicleImageData(int ID)
        {
            ...
            try
            {
                var resultdata = _dbcontext.VFittedOrders.FirstOrDefault(w => w.HSRPOrderID == ID);
                if (resultdata == null)
                {
                ...
                _auditLogger.SaveActionLog("VehicleImage", ActionType.Select, ID.ToString(), ID, null, "FittedOrdersServiceRepository.GetVehicleImageData()");
            }
            catch (Exception ex)
            {
                dataResponse = _errorLoggerService.LogException(ex, ID, "FittedOrdersServiceRepository.GetVehicleImageData()");
            }
