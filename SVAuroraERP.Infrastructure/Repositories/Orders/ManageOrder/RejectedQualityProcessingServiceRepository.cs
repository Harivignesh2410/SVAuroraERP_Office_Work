...
{
    public class RejectedQualityProcessingServiceRepository : IRejectedQualityProcessingServiceRepository
    {
        private readonly SVAuroraERPDbContext _dbcontext;
        private readonly IErrorLoggerService _errorLoggerService;
        private readonly IAuditLogger _auditLogger;
        public RejectedQualityProcessingServiceRepository(IErrorLoggerService errorLoggerService,
        ...
        public DataResponse GetRejectedQualityProcessing(RejectedQualityProcessingRequest request)
        {
            ...
            try
            {
                ...
                IQueryable<VRejectedQualityProcessing> query = _dbcontext.VRejectedQualityProcessing;
                ...
                var totalRecords = _dbcontext.VRejectedQualityProcessing.Count();
                ...
                _auditLogger.SaveActionLog("VRejectedQualityProcessing", ActionType.ListData, null, request, null, "RejectedQualityProcessingServiceRepository.GetRejectedQualityProcessing()");
            }
            catch (Exception ex)
            {
                response = _errorLoggerService.LogException(ex, request, "RejectedQualityProcessingServiceRepository.GetRejectedQualityProcessing()");
            }
            return response;
        }
    }
