...
{
    public class DealerSubUserModel : BasePageModel
    {
        ...
        private const int PageControlID = (int)Common.Pages.DealerSubUser; // ID for this specific page

        public DealerSubUserModel(IHSRPUserServiceRepository respository,
       ...
       // public List<SelectListItem> DealerList { get; set; } = new List<SelectListItem>();
        ...
        public JsonResult OnGetSubDealerByID(int ID)
        {
        ...
        public JsonResult OnPostSubDealerList([FromForm] HSRPUserRequest dataTableRequest)
        {
            try
            {
                ...
                dataTableRequest.UserTypeID = (byte)HSRPUserTypeEnum.DealerSubUsers;
                DataResponse dataResponse = new DataResponse();
