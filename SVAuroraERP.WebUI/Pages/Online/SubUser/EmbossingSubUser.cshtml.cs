...
{
    public class EmbossingSubUserModel : BasePageModel
    {
        ...
        private const int PageControlID = (int)Common.Pages.EmbossingSubUser; // ID for this specific page

        public EmbossingSubUserModel(IHSRPUserServiceRepository respository,
        ...
        public void LoadEmbossingStationList()
        {
            DataResponse dataResponse = new DataResponse();
            ...
            EmbossingStationList = ((List<VHSRPUser>)dataResponse.Value)
                ...
                .Select(s => new SelectListItem
                {
                    ...
                    Text = s.CompanyName + " (" + s.DistrictName + ")"
                }).ToList();

            EmbossingStationList.Insert(0, new SelectListItem { Value = "0", Text = "--Select EmbossingStation--" });
        }
        ...
        public JsonResult OnGetEmbossingSubUserByID(int ID)
        {
        ...
        public JsonResult OnPostEmbossingSubUserList([FromForm] HSRPUserRequest dataTableRequest)
        {
            try
            {
                ...
                dataTableRequest.UserTypeID = (byte)HSRPUserTypeEnum.EmbossingSubUsers;
                DataResponse dataResponse = new DataResponse();
            ...
            {
                _logger.LogError(ex, "Error loading Embossing Sub - User data");
