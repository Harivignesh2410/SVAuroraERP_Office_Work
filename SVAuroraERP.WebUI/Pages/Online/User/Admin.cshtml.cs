namespace SVAuroraERP.WebUI.Pages.Online.User
{
    public class AdminModel : BasePageModel
    {
        ...
        private const int PageControlID = (int)Common.Pages.Admin; // ID for this specific page
        public AdminModel(IHSRPUserServiceRepository respository,
        ...
        public JsonResult OnGetAdminByID(int ID)
        {
        ...
        public JsonResult OnPostAdminList([FromForm] HSRPUserRequest dataTableRequest)
        {
            try
            {
                ...
                dataTableRequest.UserTypeID = (byte)HSRPUserTypeEnum.Admin;
                DataResponse dataResponse = new DataResponse();
