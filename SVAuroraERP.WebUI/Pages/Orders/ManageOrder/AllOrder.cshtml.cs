...
{
    public class AllOrderModel : HSRPBasePageModel
    {
        private readonly ILogger<AllOrderModel> _logger;
        private readonly IHSRPOrdersServiceRepository _hsrpOrdersServiceRepository;
        private readonly IErrorLoggerService _errorLoggerService;
        private readonly IAuditLogger _auditLogger;
        private readonly IAntiforgery _antiforgery;
        private readonly IPermissionServiceRepository _permissionrepository;
        private const int PageControlID = (int)Common.Pages.Allorder; // ID for this specific page
        public AllOrderModel(ILogger<AllOrderModel> logger,
        ...
        public JsonResult OnPostHSRPOrderListData([FromForm] HsrpOrderRequest dataTableRequest)
        {
            try
            {
                ...
                var validColumns = new[] { "OrderNo", "RegNo", "Dealer", "OEM", "DealerCity", "OEMCity", "EmbossingStation", "EmbossingStationCity", "DealerCode", "OEMCode", "EmbossingStationCode" };
                ...
                else if (HSRPLoggedUser.HSRPUserTypeID == (byte)Common.HSRPUserType.EmbossingStation)
                {
