...
{
    public class DeliveryAcknowledgementModel : HSRPBasePageModel
    {
        private readonly ILogger<DeliveryAcknowledgementModel> _logger;
        ...
        private const int PageControlID = (int)Common.Pages.HsrpDeliveryAcknowledgement; // ID for this specific page
        public DeliveryAcknowledgementModel(ILogger<DeliveryAcknowledgementModel> logger,
        ...
        public IActionResult OnGet()
        {
            ...
            {
                return RedirectToPage("/Orders/ViewOrders/ViewDeliveryAcknowledgement");
            }
            // Normal logic here
            return Page();
        }
