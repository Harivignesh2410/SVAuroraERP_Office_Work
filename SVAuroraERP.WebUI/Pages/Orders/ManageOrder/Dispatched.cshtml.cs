...
{
    public class DispatchedModel : HSRPBasePageModel
    {
        private readonly ILogger<DispatchedModel> _logger;
        ...
        private const int PageControlID = (int)Common.Pages.Dispatched; // ID for this specific page
        private readonly IHSRPOrdersServiceRepository _repository;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public DispatchedModel(ILogger<DispatchedModel> logger,
                                        IDispatchedServiceRepository DispatchedServiceRepository,
        ...
        public IActionResult OnGet()
        {
            ...
            {
                return RedirectToPage("/Orders/ViewOrders/ViewDispatched");
            }
            // Normal logic here
            return Page();
        }
        ...
        public JsonResult OnPostDispatchedListData([FromForm] DispatchedOrdersRequest dataTableRequest)
        {
            try
            {
                ...
                dataResponse = _DispatchedServiceRepository.GetDispatched(dataTableRequest);
            ...
            catch (Exception ex)
            {
                ...
                return new JsonResult(new
                {
                    ...
                    recordsTotal = 0,
                    recordsFiltered = 0,
                    data = new List<VDispatchedOrders>()
                });
            }

        }
        public JsonResult OnGetSummaryForDispatched()

        {
            var Request = new SummaryFilterData();
            Request.UserID = (int)HSRPLoggedUser.HSRPUserID;
            Request.OrderStatusID = (int)OrderStatus.QCCompleted;
