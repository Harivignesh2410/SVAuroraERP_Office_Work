...
{
    public class ViewAPISubmittedOrdersModel : HSRPBasePageModel
    {
        private readonly ILogger<ViewAPISubmittedOrdersModel> _logger;
        private readonly IHSRPOrdersServiceRepository _repository;
        private readonly IErrorLoggerService _errorLoggerService;
        private readonly IAuditLogger _auditLogger;
        private readonly IAntiforgery _antiforgery;
        private readonly IPermissionServiceRepository _permissionrepository;
        private const int PageControlID = (int)Common.Pages.ViewAPISubmittedOrders; // ID for this specific page
        private readonly IAPISubmissionServiceRepository _fittedOrdersServiceRepository;

        public ViewAPISubmittedOrdersModel(ILogger<ViewAPISubmittedOrdersModel> logger,
                                        ...
                                        )
        {
            ...
            _repository = hSRPOrdersServiceRepository;
        }
        ...
        public IActionResult OnGet()
        {
            ...
            if (!Permissions.HasAccess) return RedirectToPage("/AccessDenied");
            //if (HSRPLoggedUser.HSRPUserTypeID != (byte)Common.HSRPUserType.Admin)
            //{
        ...
        public JsonResult OnGetSummaryForFittedOrder()
        {
            ...
            var response = _repository.SummaryOrdersByStatusID(Request);
