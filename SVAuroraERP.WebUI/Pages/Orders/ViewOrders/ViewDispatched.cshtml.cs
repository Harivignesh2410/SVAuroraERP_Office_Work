...
{
    public class ViewDispatchedModel : HSRPBasePageModel
    {
        private readonly ILogger<ViewDispatchedModel> _logger;
        ...
        private const int PageControlID = (int)Common.Pages.ViewDispatched; // ID for this specific page
        private readonly IHSRPOrdersServiceRepository _repository;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public ViewDispatchedModel(ILogger<ViewDispatchedModel> logger,
