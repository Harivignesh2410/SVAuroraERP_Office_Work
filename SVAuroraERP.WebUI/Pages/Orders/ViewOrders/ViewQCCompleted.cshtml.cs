...
{
    public class ViewQCCompletedModel : HSRPBasePageModel
    {
        private readonly ILogger<ViewQCCompletedModel> _logger;
        ...
        private const int PageControlID = (int)Common.Pages.ViewQCCompleted; // ID for this specific page
        private readonly IHSRPOrdersServiceRepository _Orderrepository = null!;
        public ViewQCCompletedModel(ILogger<ViewQCCompletedModel> logger,
