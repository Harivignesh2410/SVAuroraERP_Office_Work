...
{
    public class ViewTotalCancelledOrderModel : HSRPBasePageModel
    {
        private readonly ILogger<ViewTotalCancelledOrderModel> _logger;
        ...
        private const int PageControlID = (int)Common.Pages.ViewTotalCancelledOrder; // ID for this specific page
        private readonly IHSRPOrdersServiceRepository _Orderrepository;
        public ViewTotalCancelledOrderModel(ILogger<ViewTotalCancelledOrderModel> logger,
