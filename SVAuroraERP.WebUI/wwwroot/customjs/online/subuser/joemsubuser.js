...
$("#btnAddNew").click(function () {
    ...
    $("#divAddEdit .card-title").html("<i class='fas fa-plus-square'></i>&nbsp;&nbsp;Add New OEM Sub User");
    $("#divaddnew").hide();
    $("#divAddEdit").show();
    GetGlobalRoleIDByPageID(7, "ddlApplication", "ddlUserRole");
    ClearFormFields();
...
$("#btnSave,#btnUpdate").on('click', function () {
    ...
    EmbossingSubUserData.HSRPUserTypeID = 7;
    EmbossingSubUserData.DealerID = null;
    EmbossingSubUserData.OEMID = $('#ddlOEMList').val();
    EmbossingSubUserData.EmbossingStationID = null;
    ...
    if (!EmbossingSubUserData.OEMID || EmbossingSubUserData.OEMID === "0") return markInvalid("#ddlOEMList", " Please Select OEM");
...
function getRecordList() {
    ...
    $('#tblrecordlist').DataTable({
        ...
        "columns": [
            ...
            { "data": "OEMCompanyName", "orderable": true, "width": "5%" },
            {
                data: null,
