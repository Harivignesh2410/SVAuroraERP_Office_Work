...
$(function () {
    ...
    GetOEMByEmbossingStationList("ddlOEMFilter", OEMListByEmbossingStationUrl, _TOKEN, USERID);
    GetEmbossingStationByUser("ddlEmbossingStationFilter", EmbossingStationByUserUrl, _TOKEN, USERID);
    $("#btnFilter").click();
    getSummaryList();
    pLoadingSetup(true);
});
        ...
        columns: [
            {
                ...
                render: function (data, type, row) {
                   ...
                   data-embossingid="${row.EmbossingStationID}" />`;
                }
            },
            {
                data: null,
